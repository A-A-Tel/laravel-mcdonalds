        ...
        <main>
            ...
            <div class="mcdonalds-world-container">
                ...
                <div class="generic-text-box">
                    ...
                    <p>Al bent u aan het genieten in de staten, de prachtige landschappen van Japan, de lage landen langs the Europese kust of the kleine eilanden van Hawaii, er is altijd een McDonald's bij u in de buurt.</p>
            ...
            <div class="cafe-container">
                <div class="generic-text-box">
                    ...
                    <p>McDonald's bied veel andere restaurants uit met McCafé. Hier zal een van onze geweldige en vriendelijke crewleden uw koffie persoonlijk maken. Wij bieden veel keuzes in soorten koffie, soorten melk en versnaperingen zoals appeltaarten en brownies</p>
                </div>
            </div>
        </main>
    </body>
